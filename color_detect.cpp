/*
*	Desafio da Seleção para Iniciação Científica
*	
...
*	Autor: Eduardo Gomes
*
*	Data da última modificação: 08/04/2023
*/
...
int main(){
	...
	if(!webCam.isOpened()) return -1;											// Valida a disponibilidade da fonte de vídeo
		...
		while(1){																// loop infinito
			...
			putText(frameCopy, locX, pointTextX, FONT_HERSHEY_SIMPLEX, 0.75, Scalar(0, 0, 0), 2, LINE_8);		// Imprime a localização e área do contorno obtido
